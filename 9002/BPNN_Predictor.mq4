...
extern int    ntr         =300;   // # of training sets
...
//Global variables
int lb,nf,nin,nout,lSz[],prevBars;
double maxMSE;
...
// Train NN -----------------------------------------------------------------------------+
   ...
   for(i=0;i<ntr;i++)
   {
      realOut[lb+i]=Open[lb+i];
      trainedOut[lb+i]=(1.0+outTrain[ntr-1-i])*Open[lb+i+1];
